...
<form action="main.php?preset=mouvement" method="post">
	Boost bouclier : <input type="number" name="ppMove" min="0" /><br />
	Boost Armes : <input type="number" name="ppMove" min="0"/><br />
	Reparations : <input type="number" name="ppMove" min="0" /><br />
